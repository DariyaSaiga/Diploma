...
PKL_PATH = "/Users/dariyaablanova/Desktop/unic_work/Diploma/Diploma_clone/Diploma/datasets/mosei_bert_custom.pkl"
...
class MOSEIDataset(Dataset):
    ...
    def __init__(self, split_data):
        ...
        self.text = torch.tensor(split_data["text"], dtype=torch.float32)[valid]
        ...
        print(f"  Text shape   : {self.text.shape}")
    ...
    def __getitem__(self, idx):
        ...
        return {
            "text"      : self.text[idx],      # [50, 768] — готовые BERT embeddings
            "audio"     : audio,               # [60, 74]
