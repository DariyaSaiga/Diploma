...
\input{figures/arch_comparison_bar}
...
\input{figures/perclass_f1_comparison}
...
\toprule
& \multicolumn{4}{c}{\textit{Compact / handcrafted features}}
& \multicolumn{2}{c}{\textbf{This work}}
& \multicolumn{2}{c}{\textit{Neural audio \& visual}} \\
\cmidrule(lr){2-5}\cmidrule(lr){6-7}\cmidrule(lr){8-9}
\textbf{Metric}
    & \textbf{Affect-Diff}     & \textbf{LF-LSTM}          & \textbf{LF-Transf.}       & \textbf{MulT}
    & \textbf{Proposed}        & \textbf{Proposed}
    & \textbf{XMBT}            & \textbf{MER-SEM-MBT} \\
    & \cite{sanjyal2026affectdiff} & \cite{nguyen2025enhanced} & \cite{nguyen2025enhanced} & \cite{tsai2019multimodal}
    & \textit{(default)}       & \textit{(tuned)}
    & \cite{nguyen2025enhanced} & \cite{xia2022multimodal} \\
\midrule
\textbf{Avg.~F1}
    & 0.214 & 0.433 & 0.444 & 0.475
    & \textbf{0.485} & \textbf{0.494}
    & 0.496 & 0.509 \\[2pt]
\textbf{Avg.~WA}
    & --    & 0.631 & 0.641 & 0.672
    & \textbf{0.678} & 0.667
...
\textit{Text}
    ...
    & ALBERT   & BERT \\[2pt]
\textit{Audio}
    & COVAREP  & std.  & std.  & COVAREP
    & COVAREP  & COVAREP
    & VGGish   & VGGish \\[2pt]
\textit{Visual}
    & OpenFace & std.  & std.  & Facet
    & OpenFace & OpenFace
    & {--}     & ResNet18 \\
\bottomrule
\end{tabular}
