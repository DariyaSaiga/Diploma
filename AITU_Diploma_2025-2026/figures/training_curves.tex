...
\addlegendentry{Proposed (frozen BERT)}
...
\end{axis}
\end{tikzpicture}
\caption{Training loss (left) and validation macro-F1 (right) over 18 epochs for the proposed model with frozen BERT and Baseline 1. The proposed model reaches its best validation macro-F1 at epoch 3. Early stopping with patience 10 terminates training at epoch 18.}
