const AUTHORS = [
  ...
  },
  {
    ...
    email: "Alpieva60023081@gmail.com",
  },
];
    ...
    <footer className="bg-[#111] text-white px-10 pt-12 pb-8 max-md:px-5 max-md:pt-10 max-md:pb-7">
      <div className="grid grid-cols-3 max-md:grid-cols-1 gap-10 max-md:gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a
            href="https://github.com/DariyaSaiga/Diploma.git"
            target="_blank"
            rel="noreferrer"
            className="btn-press inline-flex items-center w-fit gap-2 px-4 py-2 rounded border border-white/15 text-sm text-white/70 no-underline hover:border-red-700 hover:text-white hover:shadow-[0_0_36px_rgba(185,28,28,1),0_0_80px_rgba(185,28,28,0.5)] transition-all duration-200"
          >
        ...
        {AUTHORS.map((author) => (
          <div key={author.name}>
            ...
            <p className="text-md lg:text-base text-white font-semibold mb-1">
              {author.name}
            </p>
